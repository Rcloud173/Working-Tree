    ...
    <div style={DASHBOARD_STYLE}>
      <style>{`
        ...
        @media (min-width: 768px) {
          ...
          .weather-hero-stats { grid-column: span 1; }
          .weather-hourly { grid-column: 1 / -1; }
          .weather-sun-aqi-uv { grid-template-columns: repeat(3, 1fr); }
          .weather-daily { grid-column: 1 / -1; }
          .weather-rain-map { grid-template-columns: 1fr 1fr; }
        }
        @media (min-width: 1024px) {
          .weather-grid { grid-template-columns: 1fr 280px; grid-template-rows: auto auto 1fr auto auto auto; }
          .weather-hero { grid-column: 1; grid-row: 1; }
          .weather-stats { grid-column: 2; grid-row: 1 / 3; }
          .weather-hourly { grid-column: 1 / -1; grid-row: 2; }
          .weather-sun-aqi-uv { grid-column: 1 / -1; grid-row: 3; display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; }
        ...
        <>
          ...
          {isLoading && !currentWeather ? (
            ...
            <div className="weather-grid" style={{ gap: 16 }}>
              ...
              <div className="weather-sun-aqi-uv" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16 }}>
